...
module.exports = async (client, guild) => {
    ...
    if (bcount > 30 && mcount < bcount) {
        guild.owner.send(`Hey, your guild has ${bcount} Bots and only ${mcount} Member. I don't like that, I will leave`).catch((O_o) => O_o);
        ...
        await possiblechannels.last().send(`Hey ${guild.owner}, your guild has ${bcount} Bots and only ${mcount} Member. I don't like that, I will leave`);
        return guild.leave();
    }
